...
public class ThongKeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(tanhoa.hcm.ditagis.com.qlcln.R.layout.activity_thong_ke);
        ...
        this.txtTongItem = this.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txtTongItem);
        ((LinearLayout) ThongKeActivity.this.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_thongke_thoigian)).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showDialogSelectTime() {
        ...
        View layout = getLayoutInflater().inflate(tanhoa.hcm.ditagis.com.qlcln.R.layout.layout_listview_thongketheothoigian, null);
        final View layoutDateTimePicker = View.inflate(this, tanhoa.hcm.ditagis.com.qlcln.R.layout.date_time_picker, null);
        ListView listView = (ListView) layout.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.lstView_thongketheothoigian);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (itemAtPosition.getId() == finalItems.size()) {
                    ...
                    View layout = getLayoutInflater().inflate(tanhoa.hcm.ditagis.com.qlcln.R.layout.layout_thongke_thoigiantuychinh, null);
                    builder.setView(layout);
                    ...
                    final EditText edit_thongke_tuychinh_ngaybatdau = (EditText) layout.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.edit_thongke_tuychinh_ngaybatdau);
                    final EditText edit_thongke_tuychinh_ngayketthuc = (EditText) layout.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.edit_thongke_tuychinh_ngayketthuc);
                    ...
                    layout.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.btn_layngaythongke).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
    ...
    public void showDateTimePicker(final EditText editText, final StringBuilder output, final String typeInput) {
        ...
        final View dialogView = View.inflate(this, tanhoa.hcm.ditagis.com.qlcln.R.layout.date_time_picker, null);
        final android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(this).create();
        dialogView.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.date_time_set).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatePicker datePicker = (DatePicker) dialogView.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.date_picker);
                Calendar calendar = new GregorianCalendar(datePicker.getYear(), datePicker.getMonth(), datePicker.getDayOfMonth());
                String displaytime = (String) DateFormat.format(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.format_time_day_month_year), calendar.getTime());
                String format = null;
                ...
                SimpleDateFormat dateFormatGmt = new SimpleDateFormat(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.format_day_yearfirst));
    ...
    private void query(ThongKeAdapter.Item item) {
        ((TextView) ThongKeActivity.this.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_thongke_mota)).setText(item.getMota());
        TextView txtThoiGian = ThongKeActivity.this.findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_thongke_thoigian);
    ...
    private void getQueryDiemDanhGiaAsync(String whereClause) {
        ListView listView = (ListView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.listview);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, final long id) {
                ...
                returnIntent.putExtra(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.ket_qua_objectid), adapter.getItems().get(position).getObjectID());
