...
public class QuanLyChatLuongNuoc extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    private void setOnClickListener() {
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_open_street_map).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_street_map).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_topo).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnLayer).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnAdd).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.btn_add_feature_close).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.btn_layer_close).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layvitri).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnLocation).setOnClickListener(this);
        findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnHome).setOnClickListener(this);
    }
    ...
    private void setUp() {
        ...
        colors = new int[]{tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1};
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(this, drawer, toolbar, tanhoa.hcm.ditagis.com.qlcln.R.string.navigation_drawer_open, tanhoa.hcm.ditagis.com.qlcln.R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();

        NavigationView navigationView = (NavigationView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.nav_view);
    ...
    private void initMapView() {
        mMapView = findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.mapView);
        ...
        final EditText edit_latitude = ((EditText) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.edit_latitude));
        final EditText edit_longtitude = ((EditText) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.edit_longtitude));
    ...
    private void setFeatureService() {
        ...
        for (final LayerInfoDTG layerInfoDTG : ListObjectDB.getInstance().getLstFeatureLayerDTG()) {
            ...
            if (layerInfoDTG.getId() != null && layerInfoDTG.getId().equals(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.id_maudanhgia))) {
                mFeatureLayerDTGS.add(featureLayerDTG);
            }
...
//                    mArcGISMapImageLayerThematic.setMinScale(10000000);
        ...
        mMap.addDoneLoadingListener(new Runnable() {
            ...
            public void run() {
                ...
                LinearLayout linnearDisplayLayer = (LinearLayout) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.linnearDisplayLayer);
                int states[][] = {{android.R.attr.state_checked}, {}};
                int colors[] = {tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1};
                for (final FeatureLayerDTG layer : mFeatureLayerDTGS) {
                    if (layer.getFeatureLayer().getId() != null && layer.getFeatureLayer().getId().equals(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.id_diemdanhgianuoc))) {
                ...
                for (int i = 0; i < linnearDisplayLayer.getChildCount(); i++) {
                    ...
                    if (v instanceof CheckBox) {
                        if (((CheckBox) v).getText().equals(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.alias_diemdanhgianuoc)))
    ...
    private void setLicense() {
        //way 1
        ArcGISRuntimeEnvironment.setLicense(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.license));
    }
...
//                    Toast.makeText(QuanLyChatLuongNuoc.this, message, Toast.LENGTH_LONG).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(tanhoa.hcm.ditagis.com.qlcln.R.menu.quan_ly_su_co, menu);
        mTxtSearch = (SearchView) menu.findItem(tanhoa.hcm.ditagis.com.qlcln.R.id.action_search).getActionView();
        mTxtSearch.setQueryHint(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.title_search));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
        if (id == tanhoa.hcm.ditagis.com.qlcln.R.id.nav_thongke) {
            final Intent intent = new Intent(this, ThongKeActivity.class);
            this.startActivityForResult(intent, requestCode);
        } else if (id == tanhoa.hcm.ditagis.com.qlcln.R.id.nav_tracuu) {
...
//            this.startActivityForResult(intent, 1);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnLayer:
                v.setVisibility(View.INVISIBLE);
                ((LinearLayout) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer)).setVisibility(View.VISIBLE);
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_open_street_map:
                mMapView.getMap().setMaxScale(1128.497175);
                mMapView.getMap().setBasemap(Basemap.createOpenStreetMap());
                handlingColorBackgroundLayerSelected(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_open_street_map);
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_street_map:
                mMapView.getMap().setMaxScale(1128.497176);
                mMapView.getMap().setBasemap(Basemap.createStreets());
                handlingColorBackgroundLayerSelected(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_street_map);
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_topo:
                mMapView.getMap().setMaxScale(5);
                mMapView.getMap().setBasemap(Basemap.createImageryWithLabels());
                handlingColorBackgroundLayerSelected(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_topo);

                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.btn_layer_close:
                ((LinearLayout) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer)).setVisibility(View.INVISIBLE);
                ((FloatingActionButton) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnLayer)).setVisibility(View.VISIBLE);
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.img_layvitri:
//                mMapViewHandler.capture();
                capture();
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnAdd:
                ((LinearLayout) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.linear_addfeature)).setVisibility(View.VISIBLE);
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_map_pin)).setVisibility(View.VISIBLE);
                ((FloatingActionButton) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnAdd)).setVisibility(View.GONE);
                mMapViewHandler.setClickBtnAdd(true);
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.btn_add_feature_close:
                ((LinearLayout) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.linear_addfeature)).setVisibility(View.GONE);
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_map_pin)).setVisibility(View.GONE);
                ((FloatingActionButton) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnAdd)).setVisibility(View.VISIBLE);
                mMapViewHandler.setClickBtnAdd(false);
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnLocation:
                if (!mLocationDisplay.isStarted()) mLocationDisplay.startAsync();
                else mLocationDisplay.stop();
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.floatBtnHome:
                goHome();
                break;
        }
    }
...
//        this.mUri = Uri.fromFile(photo);
    ...
    private void handlingColorBackgroundLayerSelected(int id) {
        switch (id) {
            case tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_open_street_map:
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_open_street_map)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_open_street_map)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorPrimary));
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_street_map)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap_none);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_street_map)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1));
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_topo)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap_none);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_topo)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1));
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_street_map:
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_street_map)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_street_map)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorPrimary));
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_open_street_map)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap_none);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_open_street_map)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1));
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_topo)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap_none);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_topo)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1));
                break;
            case tanhoa.hcm.ditagis.com.qlcln.R.id.layout_layer_topo:
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_topo)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_topo)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorPrimary));
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_open_street_map)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap_none);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_open_street_map)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1));
                ((ImageView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.img_layer_street_map)).setBackgroundResource(tanhoa.hcm.ditagis.com.qlcln.R.drawable.layout_shape_basemap_none);
                ((TextView) findViewById(tanhoa.hcm.ditagis.com.qlcln.R.id.txt_layer_street_map)).setTextColor(ContextCompat.getColor(this, tanhoa.hcm.ditagis.com.qlcln.R.color.colorTextColor_1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        try {
            String returnedResult = data.getExtras().get(getString(tanhoa.hcm.ditagis.com.qlcln.R.string.ket_qua_objectid)).toString();
